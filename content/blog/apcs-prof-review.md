---
title: "Cảm nhận về các giáo ở APCS mình từng học"
extra:
    add_toc: true
date: 2025-09-06
description: "Các bạn đấm nhau vỡ mồm và đóng tiền ngập mặt để vào cái chương trình này. Để xem các giảng viên của bạn là ai..."
taxonomies:
    tags: ["vietnamese", "apcs"]
---

Các bạn đấm nhau vỡ mồm và đóng tiền ngập mặt để vào cái chương trình này. Để xem các giảng viên của bạn là ai...

**Lưu ý:** Đây là ý kiến và cảm nhận mang tính chủ quan của mình, được hình thành qua các sự kiện, tình huống cụ thể. Chưa chắc những gì mình viết ở đây sẽ đúng với bạn.
...
- Nguyễn Tấn Trung: thầy cũng chỉ lên lớp (thường xuyên trễ), đọc sách, cho làm bài tập và hay pha trò trong lớp (cringe). Thầy có thể tự dưng không dạy nữa và karaoke trong lớp (thầy hát dở). Thầy có thể vứt rác trong lớp và cô trợ giảng sẽ dọn cho thầy. Thầy quan tâm đến ICPC các thứ, cũng có gặp mình hồi Regional ở Huế. Sau khóa mình thì thầy đã nghỉ để sang trường UMT.
- Trần Như Sính: Cô dạy cũng bình thường, cũng dễ tính. Cô theo thầy nên sau khóa mình, cô cũng nghỉ (còn sang đâu thì không rõ).

### CS251 - Logical Structures

- Nguyễn Phúc Sơn: Giỏi, tư duy hay, cũng là một trong những giáo hàng đầu ở APCS. Nhưng có lẽ mình không hợp thầy lắm nên mình không thấm được thầy.
- Nguyễn Hữu Trí Nhật: Giống [MTH261](#mth261-linear-algebra).
...
- Trần Minh Triết: Lên đọc slide, nhờ ChatGPT code, lâu lâu kể vài câu chuyện và kết thúc. Môn để kéo điểm nên không có gì đặc biệt trong giảng dạy.
- Đội ngũ đứng lớp thật sự: Cũng không dạy gì hay ho nên mình cũng toàn sủi học. Trước mình có nghe là có chấm điểm bằng MSSV, bọn còn lại thì các thầy mở 10 cái report cạnh nhau rồi đọc cùng một lúc.

### CS320 - Principles of Programming Languages

- Đinh Điền (phiên bản ngôn ngữ): Là phiên bản gây sụp đổ hình tượng mà thầy xây dựng ở phiên bản low-level. Thầy không dạy gì, nghĩ ra mấy thứ câu hỏi đánh đố để câu giờ. Kiến thức thầy dạy trong nửa kì thì BKHCM dạy trong 1 buổi. Nửa kì còn lại là seminar, các bạn tự làm còn thầy dùng ChatGPT rồi phát biểu như là người có hiểu biết. Với tư cách là một người có hứng thú với lý thuyết ngôn ngữ lập trình (và từng học ké môn này ở NUS) thì môn này Đinh Điền dạy dưới mức chấp nhận được. Khóa mình, thầy còn cố gắng nhét LLM vào và dùng lý do "low-code" để bao biện (trong khi mình đang ở công ty làm về low-code). Nhóm mình viết interpreter cho 1 ngôn ngữ chính thống (OCaml) và đạt điểm thấp hơn các nhóm trong lab của thầy.
- Lương An Vinh: Không có dấu hiệu cho thấy thầy biết gì về lý thuyết ngôn ngữ lập trình.
- Nguyễn Hồng Bửu Long: Thầy có vẻ biết chút kiến thức và mình cũng từng quý thầy, cho đến khi trong một bài tập lớn, thầy phản biện mình rằng LLM là một search engine. Điều này khiến mình mất niềm tin vào đào tạo tiến sĩ CNTT ở HCMUS.
...
- Nguyễn Lê Hoàng Anh: Trưởng bộ môn Tối ưu ở khoa Toán. Thầy dễ thương, dạy cũng hay và dễ hiểu, có giảng lại bằng tiếng Việt cho những bạn mới vào môi trường tiếng Anh và chưa quen. Thầy có vẻ không còn dạy toán ở khoa CNTT nữa sau khóa mình.
- Nguyễn Mạnh Trường Giang: Thầy khá bình thường, mình không có nhiều ký ức về thầy. Thầy đi theo thầy Hoàng Anh nên cũng ngừng dạy ở khoa CNTT sau khóa mình.
...
- Nguyễn Thị Hoài Thương: Dạy cũng ổn, mỗi tội cô nói tiếng Anh hơi chói tai. Cho phép bấm máy tính cầm tay ra đáp số khi tích phân chỉ còn 1 biến. Phải đi học đầy đủ để làm bài tập (nhưng hình như bài nào mình cũng 10đ, cô cho trao đổi siêu thoải mái nhưng đừng làm gì để cô phật ý).
- Aki Lê (Lê Văn Chánh): Giống [MTH252 - Calculus II](#mth252-calculus-ii).

### MTH261 - Linear Algebra

- Lê Văn Luyện: Đọc slide, trả lời câu hỏi sinh viên, cho bài tập rồi quay về nhìn biểu đồ giá (cổ phiếu, tiền ảo hay cái gì thì mình không biết). Tóm lại là dạy ở APCS không hay lắm, điểm cũng ???, thấy phản hồi ở CLC/TCTA có vẻ tốt hơn.
- Nguyễn Hữu Trí Nhật: Giỏi và có tâm. Các bạn không hiểu gì thì thầy sẽ giảng lại tường tận cho các bạn. Môn nào có thầy Trí Nhật thì tỉ lệ cao là sẽ dạy hay hơn giảng viên chính.

### STAT451 - Applied Stats I

- Hoàng Văn Hà: Dạy cũng tạm, người du học từ Pháp nên tiếng Anh cũng giọng Pháp (Macbook ổng dùng cũng để ngôn ngữ tiếng Pháp). Mình cũng không thấm được thầy lắm. CLC/TCTA có thể có nhận xét khác.
- Nguyễn Văn Thìn: Tại thời điểm viết bài thì mình quên sạch ký ức về thầy, xin lỗi thầy và các bạn.
...
- Vũ Thị Hạnh Thu: Mình khá chắc cô là người giỏi, nhưng cô dạy không hay lắm, chậm, chán, khó nghe và khó hiểu. Xong rồi cô cũng phải giải thích bằng tiếng Việt, trong khi cô có thể bắn tiếng Việt từ đầu cho đỡ mất thời gian.
- Nguyễn Nhật Kim Ngân: Cô hiền hơn, giảng dễ hiểu và dễ thấm hơn. Cô chỉ thích làm TA cho vui thôi.

### PH212 - Physics II

- Nguyễn Hữu Nhã: Ác mộng của các khóa APCS. Thầy dạy rất nhiều và kì vọng ở sinh viên cũng rất nhiều (các bạn phải chăm học, chăm đọc SGK, chăm làm bài tập, lâu lâu hay bị so sánh với bọn học Lý ở MIT??). Dạy có tâm, còn hợp hay không thì tùy người. Đề trung bình khó. Có cơ chế để vớt vát điểm của các bạn, có scale lại điểm theo thằng cao nhất (giống đại học nước ngoài), nhưng bằng cách nào đó cũng có thằng 10đ nên cơ chế không có tác dụng mấy.
- Nguyễn Ngọc Trường: Dạy cũng tạm được (?), cũng cho nhiều bài tập, cũng có kiểm tra (nên các bạn phải đến lớp) và hay làm mấy trò con bò để phân tâm các bạn (như mở soundtrack ma hù khi các bạn đang làm bài).

### PH213 - Physics III

- Võ Lương Hồng Phước: Dạy hay hơn, hiểu tốt hơn, tốc độ dạy tốt hơn, tiếng Anh hay hơn [cô Thu](#ph211-physics-i). Mỗi tội là bạn không cúp học được vì sẽ có bài tập.
- Nguyễn Nhật Kim Ngân: Giống [PH211 - Physics I](#ph211-physics-i).

### BAA00101 - Triết Marx-Lenin

- Nguyễn Đình Quốc Cường: Dạy cũng được. Dễ đi vào giấc ngủ nhưng sẽ lập tức bạn quay lại chỉ bằng một động tác: đang nói giữa chừng thì dí mic vào miệng (để âm lượng đột ngột tăng). Có điểm danh, các bạn nên đi học đầy đủ. Có điểm cộng nếu tham gia phát biểu.
...
### BAA00104 - Lịch sử Đảng

- Ngô Thị Kim Liên: Cô dạy hay, có năng lượng, pass the Gen Z vibe check dù cô cũng gần 50 tuổi. Có đọc đáp án trong SGK để chép vào bài thi cuối kì (còn chép đoạn nào thì các bạn phải tự dùng não). Cố gắng engage để farm điểm hoặc tìm cách lọt vào chung nhóm bọn hay farm điểm (chứ không thọt như tụi mình).
